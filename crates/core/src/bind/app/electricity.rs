...
impl AppHandler {
    ...
    pub async fn query_electricity_binding(&self) -> Result<EleBindInfo, Error> {
        let form = [("bindType", "3")];
    ...
    pub async fn query_electricity(&self, info: &RoomInfo) -> Result<ElectricityInfo, Error> {
        let mut resp = self
            .client
    ...
    pub async fn recharge_electricity(
        &self,
        info: &RoomInfo,
        amount: u32,
        cztype: &str,
